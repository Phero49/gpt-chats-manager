...
const get_chat = async () => {
  if (url != undefined && url.length > 4) {
    const chat = await $q.bex.send("storage.get", { key: url, all: false });
...
const toPdf = () => {
  ...
  pdf
    .html(html, {
      margin: 15,
      filename: Cheerio.load(store.title).text() + ".pdf",
...
const contentClass = "default-styles q-card shadow-5";
const processHtml = () => {
  const $ = Cheerio.load(`
...
var editor = ref(processHtml());

async function exportDoc() {
  const fileBuffer = await HTMLtoDOCX(editor.value, null, {
...
async function saveToDisk() {
  // Open directory picker and get the selected directory handle
  const content = editorRef.value.getContentEl();
  const dirHandle = await window.showDirectoryPicker();
  var getDirLocation = JSON.parse($q.localStorage.getItem("save_location"));
  console.log(getDirLocation);

  if (getDirLocation == null) {
    //it dir location does not exist
    const newDirHandle = await dirHandle.getDirectoryHandle("my-gpt-chats", {
      create: true,
    });
    console.log();
    $q.localStorage.set("save_location", JSON.stringify(newDirHandle));
    getDirLocation = newDirHandle;
  }

  // Create a file handle with the ".gpt" extension and write the content to it
  const fileHandle = await getDirLocation.getFileHandle("my-gpt-file.gpt", {
    create: true,
  });
...
@font-face {
  ...
  font-style: normal;
  font-weight: 400;
  src: url(https://cdn.openai.com/common/fonts/signifier/signifier-light.woff2)
    format("woff2");
}
@font-face {
  font-display: swap;
  ...
  font-style: italic;
  font-weight: 400;
  src: url(https://cdn.openai.com/common/fonts/signifier/signifier-light-italic.woff2)
    format("woff2");
}
@font-face {
  font-display: swap;
  ...
  font-style: normal;
  font-weight: 700;
  src: url(https://cdn.openai.com/common/fonts/signifier/signifier-bold.woff2)
    format("woff2");
}
@font-face {
  font-display: swap;
  ...
  font-style: italic;
  font-weight: 700;
  src: url(https://cdn.openai.com/common/fonts/signifier/signifier-bold-italic.woff2)
    format("woff2");
}
@font-face {
  font-display: swap;
...
@font-face {
  ...
  font-style: italic;
  font-weight: 400;
  src: url(https://cdn.openai.com/common/fonts/soehne/soehne-buch-kursiv.woff2)
    format("woff2");
}
@font-face {
  font-display: swap;
  ...
  font-style: normal;
  font-weight: 500;
  src: url(https://cdn.openai.com/common/fonts/soehne/soehne-kraftig.woff2)
    format("woff2");
}
@font-face {
  font-display: swap;
  ...
  font-style: italic;
  font-weight: 500;
  src: url(https://cdn.openai.com/common/fonts/soehne/soehne-kraftig-kursiv.woff2)
    format("woff2");
}
@font-face {
  font-display: swap;
  ...
  font-style: normal;
  font-weight: 600;
  src: url(https://cdn.openai.com/common/fonts/soehne/soehne-halbfett.woff2)
    format("woff2");
}
@font-face {
  font-display: swap;
  ...
  font-style: italic;
  font-weight: 600;
  src: url(https://cdn.openai.com/common/fonts/soehne/soehne-halbfett-kursiv.woff2)
    format("woff2");
}
@font-face {
  font-display: swap;
  ...
  font-style: normal;
  font-weight: 400;
  src: url(https://cdn.openai.com/common/fonts/soehne/soehne-mono-buch.woff2)
    format("woff2");
}
@font-face {
  font-display: swap;
  ...
  font-style: normal;
  font-weight: 700;
  src: url(https://cdn.openai.com/common/fonts/soehne/soehne-mono-halbfett.woff2)
    format("woff2");
}
@font-face {
  font-display: swap;
  ...
  font-style: italic;
  font-weight: 400;
  src: url(https://cdn.openai.com/common/fonts/soehne/soehne-mono-buch-kursiv.woff2)
    format("woff2");
}
...
.border-gray-400 {
  --tw-border-opacity: 1;
  border-color: rgba(172, 172, 190, var(--tw-border-opacity));
}
.border-white\/20 {
...
.bg-gray-500\/90 {
  background-color: hsla(240, 9%, 59%, 0.9);
}
.bg-red-100 {
  --tw-bg-opacity: 1;
...
.bg-orange-500\/10 {
  background-color: rgba(224, 108, 43, 0.1);
}
.bg-red-500\/10 {
...
.text-\[\#4559A4\] {
  --tw-text-opacity: 1;
  color: rgba(69, 89, 164, var(--tw-text-opacity));
}
.text-black\/50 {
...
.shadow-\[0_2px_24px_rgba\(0\2c 0\2c 0\2c 0\.05\)\],
.shadow-sm {
...
.shadow-\[0_2px_24px_rgba\(0\2c 0\2c 0\2c 0\.05\)\] {
  --tw-shadow: 0 2px 24px rgba(0, 0, 0, 0.05);
...
.toast-root[data-state="entering"] {
  -webkit-animation: toast-open 0.24s cubic-bezier(0.175, 0.885, 0.32, 1.175)
    both;
...
@font-face {
  ...
  font-style: normal;
  font-weight: 400;
  src: url(https://cdn.openai.com/common/fonts/katex/KaTeX_AMS-Regular.woff2)
    format("woff2");
}
@font-face {
  ...
  font-style: normal;
  font-weight: 700;
  src: url(https://cdn.openai.com/common/fonts/katex/KaTeX_Caligraphic-Bold.woff2)
    format("woff2");
}
@font-face {
  font-family: KaTeX_Caligraphic;
...
@font-face {
  ...
  font-style: normal;
  font-weight: 700;
  src: url(https://cdn.openai.com/common/fonts/katex/KaTeX_Fraktur-Bold.woff2)
    format("woff2");
}
@font-face {
  font-family: KaTeX_Fraktur;
  font-style: normal;
  font-weight: 400;
  src: url(https://cdn.openai.com/common/fonts/katex/KaTeX_Fraktur-Regular.woff2)
    format("woff2");
}
@font-face {
  ...
  font-style: normal;
  font-weight: 700;
  src: url(https://cdn.openai.com/common/fonts/katex/KaTeX_Main-Bold.woff2)
    format("woff2");
}
@font-face {
  font-family: KaTeX_Main;
  font-style: italic;
  font-weight: 700;
  src: url(https://cdn.openai.com/common/fonts/katex/KaTeX_Main-BoldItalic.woff2)
    format("woff2");
}
@font-face {
  font-family: KaTeX_Main;
  font-style: italic;
  font-weight: 400;
  src: url(https://cdn.openai.com/common/fonts/katex/KaTeX_Main-Italic.woff2)
    format("woff2");
}
@font-face {
  font-family: KaTeX_Main;
  font-style: normal;
  font-weight: 400;
  src: url(https://cdn.openai.com/common/fonts/katex/KaTeX_Main-Regular.woff2)
    format("woff2");
}
@font-face {
  ...
  font-style: italic;
  font-weight: 700;
  src: url(https://cdn.openai.com/common/fonts/katex/KaTeX_Math-BoldItalic.woff2)
    format("woff2");
}
@font-face {
  font-family: KaTeX_Math;
  font-style: italic;
  font-weight: 400;
  src: url(https://cdn.openai.com/common/fonts/katex/KaTeX_Math-Italic.woff2)
    format("woff2");
}
@font-face {
  ...
  font-style: normal;
  font-weight: 700;
  src: url(https://cdn.openai.com/common/fonts/katex/KaTeX_SansSerif-Bold.woff2)
    format("woff2");
}
@font-face {
  font-family: "KaTeX_SansSerif";
  font-style: italic;
  font-weight: 400;
  src: url(https://cdn.openai.com/common/fonts/katex/KaTeX_SansSerif-Italic.woff2)
    format("woff2");
}
@font-face {
  font-family: "KaTeX_SansSerif";
...
@font-face {
  ...
  font-style: normal;
  font-weight: 400;
  src: url(https://cdn.openai.com/common/fonts/katex/KaTeX_Script-Regular.woff2)
    format("woff2");
}
@font-face {
  ...
  font-style: normal;
  font-weight: 400;
  src: url(https://cdn.openai.com/common/fonts/katex/KaTeX_Size1-Regular.woff2)
    format("woff2");
}
@font-face {
  ...
  font-style: normal;
  font-weight: 400;
  src: url(https://cdn.openai.com/common/fonts/katex/KaTeX_Size2-Regular.woff2)
    format("woff2");
}
@font-face {
  ...
  font-style: normal;
  font-weight: 400;
  src: url(https://cdn.openai.com/common/fonts/katex/KaTeX_Size3-Regular.woff2)
    format("woff2");
}
@font-face {
  ...
  font-style: normal;
  font-weight: 400;
  src: url(https://cdn.openai.com/common/fonts/katex/KaTeX_Size4-Regular.woff2)
    format("woff2");
}
@font-face {
