import { c as createComponent, u as useModelToggleProps, ab as useTransitionProps, m as useModelToggleEmits, r as ref, a as computed, ac as useTick, p as useTimeout, ad as useTransition, q as useModelToggle, ae as usePortal, w as watch, o as onBeforeUnmount, a7 as cleanEvt, a6 as addEvt, aj as getScrollTarget, h, al as Transition, g as getCurrentInstance, b as hSlot, a3 as stopAndPrevent } from "./index.d7888b57.js";
import { c as useAnchorProps, v as validatePosition, d as validateOffset, p as parsePosition, e as useScrollTarget, f as useAnchor, r as removeClickOutside, s as setPosition, g as clearSelection, h as addClickOutside } from "./use-quasar.56248db4.js";
var QTooltip = createComponent({
  ...
  setup(props, { slots, emit, attrs }) {
    ...
    if ($q.platform.is.mobile === true) {
      ...
      watch(hasClickOutside, (val2) => {
        const fn = val2 === true ? addClickOutside : removeClickOutside;
...
class EntityDecoder {
  ...
  stateNamedEntity(str, offset) {
    ...
    for (; offset < str.length; offset++, this.excess++) {
      ...
      if (this.treeIndex < 0) {
        return this.result === 0 || this.decodeMode === DecodingMode.Attribute && (valueLength === 0 || isEntityInAttributeInvalidEnd$1(char)) ? 0 : this.emitNotTerminatedNamedEntity();
      }
...
const getCodePoint = String.prototype.codePointAt != null ? (str, index2) => str.codePointAt(index2) : (c, index2) => (c.charCodeAt(index2) & 64512) === 55296 ? (c.charCodeAt(index2) - 55296) * 1024 + c.charCodeAt(index2 + 1) - 56320 + 65536 : c.charCodeAt(index2);
...
function getLoad(parse2, render2) {
  return function load2(content, options, isDocument2 = true) {
    ...
    function initialize(selector, context, root2 = initialRoot, opts) {
      ...
      const elements = typeof selector === "string" && isHtml(selector) ? parse2(selector, options2, false, null).children : isNode(selector) ? [selector] : Array.isArray(selector) ? selector : void 0;
      ...
      let search = selector;
      const searchContext = !context ? rootInstance : typeof context === "string" ? isHtml(context) ? new LoadedCheerio([parse2(context, options2, false, null)], rootInstance, options2) : (search = `${context} ${search}`, rootInstance) : isCheerio(context) ? context : new LoadedCheerio(Array.isArray(context) ? context : [context], rootInstance, options2);
      if (!searchContext)
        return instance;
...
load([]);
export { QTooltip as Q, load as l };
